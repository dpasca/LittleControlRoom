...
func TestParseEditableSettings(t *testing.T) {
	...
	settings, err := ParseEditableSettings(AIBackendOpenAIAPI, "sk-test-example", "~/dev/repos,/tmp/other", "/tmp/skip", "quickgame_*,secret-demo", "medical,visa", "yolo", "10m", "2h", "45s")
	if err != nil {
