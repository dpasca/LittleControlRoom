...
func bossActionPlannerSystemPrompt() string {
	return strings.Join([]string{
		...
		"For project.set_archive_state, include project_path or exact project_name and project_archive_action=archive or unarchive.",
