...
func bossAssistantSystemPrompt() string {
	return strings.Join([]string{
		...
		"Completed delegated agent tasks can be archived to get them out of the active record; do not route that request to project TODO cleanup.",
...
func bossActionPlannerSystemPrompt() string {
	return strings.Join([]string{
		...
		"If the user asks to remove, clear, hide, or get rid of a completed delegated agent task and the task id is known, propose agent_task.close with task_close_status=archived.",
