	...
	return map[string]any{
		...
		"properties": map[string]any{
			...
			"control_capability": map[string]any{
				"type":        "string",
				"enum":        []string{"", string(control.CapabilityEngineerSendPrompt), string(control.CapabilityAgentTaskCreate), string(control.CapabilityAgentTaskContinue), string(control.CapabilityAgentTaskClose), string(control.CapabilityScratchTaskArchive), string(control.CapabilityTodoAdd), string(control.CapabilityTodoComplete)},
