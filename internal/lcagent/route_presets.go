	...
	return []lcagentRoutePreset{
		{
			...
			Description:     "Default coding lane: direct DeepSeek V4 Pro with high reasoning and conservative tool/context budgets.",
			Provider:        "deepseek",
...
func mimo25ProRoutePreset(reasoningEffort string) lcagentRoutePreset {
	...
	return lcagentRoutePreset{
		...
		Description:     "Direct Xiaomi MiMo-V2.5-Pro " + reasoningEffort + "-reasoning coding lane with larger retained context.",
		Provider:        "xiaomi",
