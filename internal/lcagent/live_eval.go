...
func runLiveEval(args []string, stdout io.Writer) error {
	...
	fs.StringVar(&routePresetRaw, "route-preset", "", "coding route preset: balanced, quality, mimo-2.5-pro-low, mimo-2.5-pro-high, mimo-2.5-pro-max, glm-5.1, or cheap-scout; explicit flags override preset values")
	fs.StringVar(&provider, "provider", "openrouter", "provider: openrouter, openai, deepseek, moonshot, xiaomi, or zai")
