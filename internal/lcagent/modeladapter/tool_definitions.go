			...
			Function: FunctionSpec{
				...
				Parameters: map[string]any{
					...
					"properties": map[string]any{
						...
						"requires_temporal_visual_verification": map[string]any{"type": "boolean", "description": "True when visual quality is stateful or time-dependent enough that completed requires analyze_image evidence comparing two observations via comparison_path."},
