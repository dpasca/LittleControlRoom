...
- **Adjust setup** — Use `/settings` for API keys, MLX/Ollama endpoint overrides, paths, and defaults, `/new-project` for repo-backed work, and `/new-task` for quick scratch work.
