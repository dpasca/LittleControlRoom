...
- Boss mode provides a chat-first high-level layer over the classic TUI, with read-only project-state queries, file-backed chat sessions, and a separate boss-chat inference configuration.
