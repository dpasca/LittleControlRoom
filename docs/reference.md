...
- `/clean`: Run a fresh, read-only Codex session-storage audit and review worktree-grouped candidates before any permanent deletion is allowed.
...
- `/clean`: Leave the embedded pane visible behind the global Codex session-storage cleanup dialog.
